    ...
    <section className="py-24 px-6 bg-white">
      <div className="max-w-4xl mx-auto">
        <div className="relative border border-[#5e25fa]/30 rounded-[2.5rem] p-10 md:p-16 text-center overflow-hidden">
          {/* Background glow */}
          <div className="absolute inset-0 bg-gradient-to-b from-[#5e25fa]/8 to-transparent pointer-events-none" />
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-48 bg-[#5e25fa]/15 blur-[80px] pointer-events-none" />

          <div className="relative">
            {/* Shield icon */}
            <div className="w-20 h-20 bg-[#5e25fa]/15 border border-[#5e25fa]/30 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-[0_0_40px_rgba(94,37,250,0.2)]">
            ...
            <p className="font-serif-italic text-2xl md:text-3xl text-[#6b6b76] mb-8">
              Results or we go hands-on. No excuses.
            </p>

            {/* Body */}
            <p className="text-[#6b6b76] text-lg leading-relaxed max-w-2xl mx-auto mb-10">
              ...
              <span className="block mt-4 text-[#050119] font-semibold">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
              {[
                ...
                <div key={point} className="flex items-center gap-2 text-[#050119]/70 text-sm">
